...
void FastExplorationFSM::init(ros::NodeHandle& nh) {
  ...
  exec_timer_ = nh.createTimer(ros::Duration(0.001), &FastExplorationFSM::FSMCallback, this);//0.01 .0.02
  safety_timer_ = nh.createTimer(ros::Duration(0.02), &FastExplorationFSM::safetyCallback, this);//0.05,0.02
