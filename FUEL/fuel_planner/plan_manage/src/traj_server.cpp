...
void visCallback(const ros::TimerEvent& e) {
  ...
  displayTrajWithColor(traj_cmd_, 0.2, Eigen::Vector4d(1, 0, 0, 1), pub_traj_id_);//我的
  //displayTrajWithColor(traj_cmd_, 0.1, Eigen::Vector4d(0, 0, 0, 1), pub_traj_id_);//rapid的
  //displayTrajWithColor(traj_cmd_, 0.1, Eigen::Vector4d(0, 0, 1, 1), pub_traj_id_);//fuel的
